...
| Drug                       | Price Change with Each Additional Plan | % Change       | Significant? | Explains x% of Variance | Interpretation                                     |
| -------------------------- | -------------------------------------- | --------------  | ------------ | ----------------------- | -------------------------------------------------- |
| **Adalimumab**             | +$1.75                                | **+0.00%**      | Yes          | 0.84                    | Small positive effect                              |
| **Apixaban**               | $0                              | **-0.00%**       | No           | 0.04                    | No evidence of relationship                        |
| **Dulaglutide**            | $-0.08                                | **-0.00%**          | No           | 0.11                    | Weak negative trend, borderline significance       |
| **Empagliflozin**          | $0.01                               | **+0.00%**          | Yes          | 0.33                    | Tiny positive effect                               |
| **Etanercept**             | $0.49                                 | **+0.00%**         | Yes          | 0.30                    | Small positive effect                              |
| **Ibrutinib**              | $0.17                                 | **+0.00%**         | Yes          | 0.22                    | Small positive effect                              |
| **Insulin Aspart**         | -$0.08                               | **-0.00%**           | No           | <0.01                   | No effect                                          |
| **Lenalidomide**           | +25.04¢                                | **+0.00%**           | Yes          | **5.01**                | Moderate positive effect                           |
| **Liraglutide**            | -12.92¢                                | **-0.16%**           | Yes          | **4.20**                | Moderate negative effect                           |
| **Paliperidone Palmitate** | +10.80¢                                | **+0.00%**             | Yes          | 0.21                    | Small positive effect                              |
| **Rivaroxaban**            | -$1.03                                | **-0.01%**             | Yes          | **2.84**                | Small but clear negative effect                    |
| **Semaglutide**            | -$1.37                                | **-0.05%**             | Yes          | **2.58**                | Small/moderate negative effect                     |
| **Tiotropium Bromide**     | +$14.2                                 | **+0.00%**             | Yes          | **6.35**                | Strongest predictive power in this group (6.4%)    |
| **Ustekinumab**            | -$5.02                                | **-0.00%**           | Yes          | 0.13                    | Weak but statistically significant negative effect |
