...
| Generic Name | Brand Name(s) | Common Conditions | Total Spend (USD) |
|------------------------|---------------|-------------------|-------------------|
...
: Table 1 - Top medications by absolute spend and the treatment condistions {.striped .hover tbl-colwidths = "[20, 20, 40, 20]" #table-top-meds }
