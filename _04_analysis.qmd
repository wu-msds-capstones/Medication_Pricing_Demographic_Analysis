...
For the rest of the analysis, we plan to use these top drugs by the most absolute spend in 2019-2023. To help contextualize what these medications treat, see the table below. {@table-top-meds}

```{=markdown}
| Medication Generic Name | Brand Name(s) | Common Conditions | Total Spend (USD) |
| ---- | ----- | ---- | ---- |
| Apixaban | Elinquis | AFib (Atrial Fibrillation), DVT/PE (Deep Vein Thrombosis / Pulmonary Embolism), Post-surgery Prophylaxis | $67.3B |
...
| Ustekinumab | Stelara | Psoriasis, PsA (Psoriatic Arthritis), Crohns | $15.2B |
...
: Top medications by absolute spend and the treatment condistions {.striped .hover #table-top-meds}
