...
Liraglutide is unique in that it has a clear state-wide price impact like in New Mexico and Minnesota, but a county level price delta in some counties scattered across other states such as Nebraska, Oregon, Washington, Tennessee, Missouri, and Virginia. (See @fig-map-liraglutide).
