...
For the rest of the analysis, we plan to use these top drugs by the most absolute spend in 2019-2023. To help contextualize what conditions these medications treat, see the table below. See @tbl-top-meds


::: {.table .striped .hover tbl-colwidths="[20,20,20,40]"}
...
Table 1: Top medications by absolute spend and the treatment conditions {#tbl-top-meds}  
