...
``` {r}
#| label: fig-map-facet
#| fig-cap: "30-day supply median drug prices by US County for 14 high total expenditure drugs. Note: The color scale is different for every drug. The highest value for each drug is yellow while the lowest value is purple."
#| warning: false
#| echo: false
#| message: false
